...
setup(
	...
	packages = [
		'bambu',
		'bambu.activity', 'bambu.activity.migrations', 'bambu.activity.templatetags',
		'bambu.analytics', 'bambu.analytics.templatetags',
		'bambu.api', 'bambu.api.auth', 'bambu.api.migrations', 'bambu.api.templatetags', 'bambu.api.xml',
		'bambu.attachments', 'bambu.attachments.templatetags', 'bambu.attachments.migrations',
		'bambu.blog', 'bambu.blog.templatetags', 'bambu.blog.migrations',
		'bambu.bootstrap', 'bambu.bootstrap.templatetags',
		'bambu.codemirror',
		'bambu.comments', 'bambu.comments.templatetags', 'bambu.comments.migrations',
		'bambu.cookiecontrol', 'bambu.cookiecontrol.templatetags',
		'bambu.cron', 'bambu.cron.migrations', 'bambu.cron.management', 'bambu.cron.management.commands',
		'bambu.dataportability', 'bambu.dataportability.migrations',
		...
		'bambu.megaphone', 'bambu.megaphone.migrations', 'bambu.megaphone.providers', 'bambu.megaphone.templatetags', 'bambu.megaphone.management', 'bambu.megaphone.management.commands',
		...
		'bambu.payments', 'bambu.payments.migrations', 'bambu.payments.gateways',
		'bambu.preview', 'bambu.preview.migrations',
		'bambu.oembed', 'bambu.oembed.templatetags', 'bambu.oembed.migrations',
	...
	package_data = {
		...
		'bambu.bootstrap': [
			...
			'static/bootstrap/datepicker/css/*.css',
			'static/bootstrap/datepicker/js/*.js',
			'static/bootstrap/datepicker/less/*.less',
		...
		'bambu.cookiecontrol': [
			'static/cookiecontrol/js/*.js'
		],
		'bambu.dataportability': [
			'templates/dataportability/*.html',
			'templates/dataportability/*.txt'
		],
		'bambu.enquiries': [
		...
		'bambu.uploadify': [
			'static/uploadify/*.css',
			'static/uploadify/*.js',
			'static/uploadify/*.png',
			'static/uploadify/*.swf',
			'static/uploadify/com/adobe/air/logging/*.as',
			'static/uploadify/com/adobe/crypto/*.as',
			'static/uploadify/com/adobe/errors/*.as',
			'static/uploadify/com/adobe/fileformats/vcard/*.as',
			'static/uploadify/com/adobe/images/*.as',
			'static/uploadify/com/adobe/net/*.as',
			'static/uploadify/com/adobe/proxies/*.as',
			'static/uploadify/com/adobe/protocols/*.as',
			'static/uploadify/com/adobe/protocols/events/*.as',
			'static/uploadify/com/adobe/protocols/util/*.as',
			'static/uploadify/com/adobe/serialization/json/*.as',
			'static/uploadify/com/adobe/utils/*.as',
			'static/uploadify/com/adobe/webapis/*.as',
			'static/uploadify/com/adobe/webapis/events/*.as'
		]	
	},
	classifiers = [
