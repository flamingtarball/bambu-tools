...
from bambu.payments import states, gateways, signals
from datetime import datetime, timedelta

class TaxRate(models.Model):
	name = models.CharField(max_length = 50)
	shorthand = models.CharField(max_length = 10, default = 'Tax')
	chargeable_percent = models.FloatField(u'chargeable %')
	payable_percent = models.FloatField(u'payable %')
...
class Payment(models.Model):
	...
	remote_id = models.CharField(u'remote ID', max_length = 100, null = True, blank = True)
	...
	def process_view(self, request, cancel = False):
...
class Status(models.Model):
	...
	def save(self, *args, **kwargs):
		...
		if new:
			if self.state == states.PAYMENT_ERROR:
