...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Service', fields ['user', 'provider']
        db.create_unique('megaphone_service', ['user_id', 'provider'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Service', fields ['user', 'provider']
        db.delete_unique('megaphone_service', ['user_id', 'provider'])
