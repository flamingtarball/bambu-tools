...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Item'
        db.create_table('megaphone_item', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('feed', self.gf('django.db.models.fields.related.ForeignKey')(related_name='items', to=orm['megaphone.Feed'])),
            ('date', self.gf('django.db.models.fields.DateTimeField')()),
            ('primary_text', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('secondary_text', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=255)),
            ('thumbnail', self.gf('django.db.models.fields.files.ImageField')(max_length=255)),
            ('place', self.gf('django.db.models.fields.related.ForeignKey')(related_name='items', null=True, to=orm['megaphone.Place'])),
            ('data', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('megaphone', ['Item'])

        # Adding unique constraint on 'Item', fields ['feed', 'url']
        db.create_unique('megaphone_item', ['feed_id', 'url'])

        # Adding model 'Place'
        db.create_table('megaphone_place', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='megaphone_places', to=orm['auth.User'])),
        ))
        db.send_create_signal('megaphone', ['Place'])

        # Adding model 'RSSFeed'
        db.create_table('megaphone_feed_rss', (
            ('feed_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['megaphone.Feed'], unique=True, primary_key=True)),
            ('url', self.gf('django.db.models.fields.URLField')(unique=True, max_length=200)),
        ))
        db.send_create_signal('megaphone', ['RSSFeed'])

        # Adding model 'Feed'
        db.create_table('megaphone_feed', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='megaphone_feeds', to=orm['auth.User'])),
            ('frequency', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('checked', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('include', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('exclude', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'])),
        ))
        db.send_create_signal('megaphone', ['Feed'])

        # Adding model 'ServiceFeed'
        db.create_table('megaphone_feed_service', (
            ('feed_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['megaphone.Feed'], unique=True, primary_key=True)),
            ('service', self.gf('django.db.models.fields.related.ForeignKey')(related_name='feeds', to=orm['megaphone.Service'])),
            ('channel', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('megaphone', ['ServiceFeed'])

        # Adding unique constraint on 'ServiceFeed', fields ['service', 'channel']
        db.create_unique('megaphone_feed_service', ['service_id', 'channel'])


    def backwards(self, orm):
        # Removing unique constraint on 'ServiceFeed', fields ['service', 'channel']
        db.delete_unique('megaphone_feed_service', ['service_id', 'channel'])

        # Removing unique constraint on 'Item', fields ['feed', 'url']
        db.delete_unique('megaphone_item', ['feed_id', 'url'])

        # Deleting model 'Item'
        db.delete_table('megaphone_item')

        # Deleting model 'Place'
        db.delete_table('megaphone_place')

        # Deleting model 'RSSFeed'
        db.delete_table('megaphone_feed_rss')

        # Deleting model 'Feed'
        db.delete_table('megaphone_feed')

        # Deleting model 'ServiceFeed'
        db.delete_table('megaphone_feed_service')
