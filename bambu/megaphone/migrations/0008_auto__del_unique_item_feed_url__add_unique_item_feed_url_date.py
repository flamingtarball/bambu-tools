...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Item', fields ['feed', 'url', 'date']
        db.create_unique('megaphone_item', ['feed_id', 'url', 'date'])


    def backwards(self, orm):
        # Removing unique constraint on 'Item', fields ['feed', 'url', 'date']
        db.delete_unique('megaphone_item', ['feed_id', 'url', 'date'])
    ...
    models = {
        ...
        'megaphone.item': {
            'Meta': {'ordering': "('-date',)", 'unique_together': "(('feed', 'url', 'date'),)", 'object_name': 'Item'},
            'data': ('django.db.models.fields.TextField', [], {}),
            'date': ('django.db.models.fields.DateTimeField', [], {}),
            'feed': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'items'", 'to': "orm['megaphone.Feed']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'children'", 'null': 'True', 'to': "orm['megaphone.Item']"}),
