...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('megaphone_item', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='children', null=True, to=orm['megaphone.Item']),
                      keep_default=False)


        # Changing field 'Item.thumbnail'
        db.alter_column('megaphone_item', 'thumbnail', self.gf('django.db.models.fields.files.ImageField')(max_length=255, null=True))

    def backwards(self, orm):
        # Deleting field 'Item.parent'
        db.delete_column('megaphone_item', 'parent_id')


        # Changing field 'Item.thumbnail'
        db.alter_column('megaphone_item', 'thumbnail', self.gf('django.db.models.fields.files.ImageField')(default=u'', max_length=255))
